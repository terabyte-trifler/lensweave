...
export type { LensWeaveCollective } from "./contracts/LensWeaveCollective";
export { LensWeaveCollective__factory } from "./factories/contracts/LensWeaveCollective__factory";
